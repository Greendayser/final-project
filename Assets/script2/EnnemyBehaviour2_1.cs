...
public class EnnemyBehaviour2_1 : MonoBehaviour
{
    ...
    private float range = 4f;                                         // zone de vision de l'ennemi
    ...
    private float vitesse = 5;                                       // represente la vitesse de l'ennemi
