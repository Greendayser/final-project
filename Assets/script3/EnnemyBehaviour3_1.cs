...
public class EnnemyBehaviour3_1 : MonoBehaviour
{
    ...
    private float range = 5f;                                         // zone de vision de l'ennemi
    ...
    private float vitesse = 3f;                                       // represente la vitesse de l'ennemi
    ...
    void Start()
    {
        ...
        borneGauche = start - 0.3f;
        borneDroite = end + 0.2f;
    }
